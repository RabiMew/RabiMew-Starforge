...
| 火箭燃料 | 地球油田 BC 采集和预处理 → IC2 电气处理 → IE 自定义精制工序 → Ad Astra 认可燃料 | 外星原料富集、集中燃料基地 | IE 原生炼油不等于完整石油化工；自定义流体配方与燃料匹配必须验证 |
...
| 自动化与物流 | 分拣、库存阈值、生产订单、弹药补给 | 工业机器与电力、前线需求 | 故障可定位、缺料有预警的跨基地系统 |
